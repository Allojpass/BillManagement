...
public class ResponseBo extends HashMap<String, Object>{
    ...
    public ResponseBo(LoginReturn loginReturn) {
        put("code", 200);
        put("msg", "操作成功");
        put("clientname",loginReturn.clientName);
        put("rolename",loginReturn.roleName);
        put("clientid",loginReturn.getClientId());
    }
    ...
    public static ResponseBo ok(LoginReturn loginReturn) {
        return new ResponseBo(loginReturn);
    }
